...
if not exist %FMDIR%\_slice4.mis goto badmerge

echo time to merge %FMDIR%\_slice1.mis %FMDIR%\_slice2.mis etc...

misdeed merge _slice1.mis _slice2.mis 0 0 1 -512 -o _combined1.mis
if not exist %FMDIR%\_combined1.mis goto badmerge
misdeed merge _combined1.mis _slice3.mis 0 0 1 0 -o _combined2.mis
if not exist %FMDIR%\_combined2.mis goto badmerge
misdeed merge _combined2.mis _slice4.mis 0 0 1 512 -o _combined3.mis
if not exist %FMDIR%\_combined3.mis goto badmerge

REM looks good! lets write over the original mission now, and clean up
rem copy /y %FMDIR%\_combined3.mis %FMDIR%\%MISNAME%.mis
